...
EP_maternal = EP_maternal %>% filter(Strain == "BW" | Strain == "ME")
...
#Write Out
write.csv(DE_strain, "dreamFMassGain_strainDE.csv")
...
write.csv(DE_F.Mass_Gain_strain, "dreamFMassGain_FMassGain_strainDE.csv")
...
# Write Out
write.csv(DE_strain, "dreamLungH20_strainDE.csv")
...
write.csv(DE_Lung_H20_strain, "dreamLungH20_LungH20_strainDE.csv")
...
# Write Out
write.csv(DE_strain, "dreamLungDM_strainDE.csv")
...
write.csv(DE_Lung_drymass_strain, "dreamLungDM_LungDM_strainDE.csv")
